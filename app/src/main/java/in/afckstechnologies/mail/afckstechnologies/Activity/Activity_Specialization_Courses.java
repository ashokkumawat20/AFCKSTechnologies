...
public class Activity_Specialization_Courses extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__specialization__courses);
                ...
                for (int i = 0; i < stList.size(); i++) {
                    ...
                    if (singleStudent.isSelected() == true) {
                        if (data.equals("")) {
                            ...
                            Config.DATA_SPLIZATION_COURSES=data;
                        }
                ...
                if (!data.equals("")) {
                    ...
                    if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                        ...
                        if (click) {
                            ...
                            prefEditor.commit();
                            Toast.makeText(Activity_Specialization_Courses.this, "Selected Courses: \n" + Config.DATA_SPLIZATION_COURSES, Toast.LENGTH_SHORT).show();
                    ...
                    finish();
                    Intent intent = new Intent(Activity_Specialization_Courses.this, Activity_Course_Details_Form.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(Activity_Specialization_Courses.this, "Please select Courses", Toast.LENGTH_SHORT).show();
                }
    ...
    private class getCoursesList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(Activity_Specialization_Courses.this);
        ...
        protected void onPostExecute(Void args) {
            if (courseListResponse.compareTo("") != 0) {
                coursesListAdpter = new NewCoursesListAdpter(Activity_Specialization_Courses.this, data);
                mleadList.setAdapter(coursesListAdpter);
                mleadList.setLayoutManager(new LinearLayoutManager(Activity_Specialization_Courses.this));
    ...
    private class submitData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            ...
            if (status) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Activity_Specialization_Courses.this);
                        ...
                        .setNegativeButton("Close", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (preferences.getString("updatecourse", "").equals("newcourse")) {
                                    ...
                                    Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(Activity_Specialization_Courses.this, Activity_Student_DashBoard.class);
                                    finish();
                                    startActivity(intent);
                                    // Close the progressdialog
                                    mProgressDialog.dismiss();
