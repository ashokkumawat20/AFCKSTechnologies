...
public class NewCoursesDAO {
    ...
    public NewCoursesDAO(String id, String frequency, String course_type_id, String course_code, String course_name, String time_duration, String prerequisite, String recommonded, String status, String fees, String image_name, String syllabuspath, String you_tube_link, String isselected, boolean isSelected) {
        this.id = id;
